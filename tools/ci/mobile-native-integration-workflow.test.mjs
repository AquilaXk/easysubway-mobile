...
test("native workflow runs one bounded Android Journey smoke and iOS simulator compile", () => {
  ...
  assert.match(
    workflow,
    /timeout 12m flutter test integration_test\/native_test\.dart -d emulator-5554 --no-dds --file-reporter "json:\$\{RUNNER_TEMP\}\/mobile-native-android\/flutter-test\.jsonl"/u,
  );
