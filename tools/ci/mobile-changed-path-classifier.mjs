...
const FEATURE_ROOTS = ["account", "ads", "attribution", "facility_report", "fare", "favorites", "get_off_alarm", "home", "home_widget", "internal_route", "mobility_profile", "network_map", "notifications", "preferences", "realtime", "route_draft", "routes", "search_history", "service_notice", "settings", "stations", "support", "train_search"];
...
const POLICY_SHA256 = "594f8d815589735a21e88e500d7a5d0684f3a461afe8b60fa58a30430865f7b0";
