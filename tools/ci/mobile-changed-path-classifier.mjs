...
const FEATURE_ROOTS = ["account", "ads", "attribution", "fare", "facility_report", "favorites", "get_off_alarm", "home", "home_widget", "internal_route", "mobility_profile", "network_map", "notifications", "preferences", "realtime", "route_draft", "routes", "search_history", "service_notice", "settings", "stations", "support", "train_search"];
...
const POLICY_SHA256 = "c32f3dc0a49a99a9acd2c124325fd86b1bc0252b030b9e5e2cdf6ebe443c4905";
