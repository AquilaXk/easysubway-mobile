...
const SAFE_TEXT = /^[^\u0000-\u001f\u007f]+$/u;
const POLICY_SHA256 = "44d86a61022e0ac8ac14becd7a6375288c2254d8719c820c512d44f827577c12";
...
const FEATURE_ROOTS = ["account", "ads", "attribution", "fare", "favorites", "get_off_alarm", "home", "home_widget", "internal_route", "journey", "mobility_profile", "network_map", "notifications", "preferences", "realtime", "route_draft", "routes", "search_history", "service_notice", "settings", "stations", "support", "train_search"];
