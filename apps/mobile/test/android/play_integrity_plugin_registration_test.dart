...
void main() {
  test(
    'clean Flutter plugin registration includes Play Integrity channel plugin',
    () {
      ...
      expect(
        pluginPubspec,
        contains('pluginClass: PlayIntegrityMethodChannelPlugin'),
      );
      expect(
        pluginPubspec,
        contains('package: com.easysubway.play_integrity_channel'),
      );
      expect(
        generatedRegistrant,
        contains(
          'com.easysubway.play_integrity_channel.PlayIntegrityMethodChannelPlugin',
        ),
      );
