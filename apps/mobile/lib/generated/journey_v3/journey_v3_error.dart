...
abstract final class JourneyErrorDispositions {
  static const Map<String, JourneyErrorDisposition> _byContext = {
    ...
    'searchStationTimetables|400|INVALID_JOURNEY_REQUEST': JourneyErrorDisposition(
      ...
      userVisible: true,
      publicMessageKey: "journey.error.invalid_journey_request",
      canonicalKoreanCopy: "역과 노선, 조회 조건을 확인해 주세요.",
      mobileResourceKey: "journeyErrorInvalidJourneyRequest",
      mobilePresentation: "FAILURE_SCREEN",
      retryDisposition: "FORBIDDEN",
      primaryActionKey: JourneyErrorActionKey.journeyActionEditRequest,
    ...
    'searchStationTimetables|404|STATION_LINE_NOT_FOUND': JourneyErrorDisposition(
      operation: 'searchStationTimetables',
      httpStatus: 404,
      code: JourneyErrorCode.stationLineNotFound,
      semanticCategory: JourneyErrorSemanticCategory.requestCorrection,
      exposure: "MOBILE_USER_VISIBLE",
      userVisible: true,
      publicMessageKey: "journey.error.station_line_not_found",
      canonicalKoreanCopy: "선택한 역의 노선 정보를 찾을 수 없어요.",
      mobileResourceKey: "journeyErrorStationLineNotFound",
      mobilePresentation: "FAILURE_SCREEN",
      retryDisposition: "FORBIDDEN",
      primaryActionKey: JourneyErrorActionKey.journeyActionReselectStation,
      secondaryActionKey: null,
      safeDiagnosticKey: "journey.diagnostic.station_line_not_found",
      sensitiveDetailPolicy: "NEVER_PUBLIC",
    ),
    'searchStationTimetables|404|TIMETABLE_NOT_COVERED': JourneyErrorDisposition(
      operation: 'searchStationTimetables',
      httpStatus: 404,
      code: JourneyErrorCode.timetableNotCovered,
      semanticCategory: JourneyErrorSemanticCategory.routeAbsent,
      exposure: "MOBILE_USER_VISIBLE",
      userVisible: true,
      publicMessageKey: "journey.error.timetable_not_covered",
      canonicalKoreanCopy: "선택한 역의 노선 시간표가 아직 준비되지 않았어요.",
      mobileResourceKey: "journeyErrorTimetableNotCovered",
      mobilePresentation: "FAILURE_SCREEN",
      retryDisposition: "FORBIDDEN",
      primaryActionKey: JourneyErrorActionKey.journeyActionReselectStation,
      secondaryActionKey: null,
      safeDiagnosticKey: "journey.diagnostic.timetable_not_covered",
      sensitiveDetailPolicy: "NEVER_PUBLIC",
    ),
    'searchStationTimetables|503|TIMETABLE_UNAVAILABLE': JourneyErrorDisposition(
      operation: 'searchStationTimetables',
      httpStatus: 503,
      code: JourneyErrorCode.timetableUnavailable,
      semanticCategory: JourneyErrorSemanticCategory.routingDataUnavailable,
    ...
    'searchStationTimetables|503|TIMETABLE_STALE': JourneyErrorDisposition(
      operation: 'searchStationTimetables',
      httpStatus: 503,
      code: JourneyErrorCode.timetableStale,
      semanticCategory: JourneyErrorSemanticCategory.routingDataStale,
    ...
    'searchStationTimetables|503|TIMETABLE_IDENTITY_MISMATCH': JourneyErrorDisposition(
      operation: 'searchStationTimetables',
      httpStatus: 503,
      code: JourneyErrorCode.timetableIdentityMismatch,
      semanticCategory: JourneyErrorSemanticCategory.routingIdentityFailure,
      exposure: "MOBILE_USER_VISIBLE",
      userVisible: true,
      publicMessageKey: "journey.error.timetable_identity_mismatch",
      canonicalKoreanCopy: "시간표 데이터 확인 중 문제가 발생했어요.",
      mobileResourceKey: "journeyErrorTimetableIdentityMismatch",
      mobilePresentation: "FAILURE_SCREEN",
      retryDisposition: "FORBIDDEN",
      primaryActionKey: JourneyErrorActionKey.journeyActionNewSearch,
      secondaryActionKey: null,
      safeDiagnosticKey: "journey.diagnostic.timetable_identity_mismatch",
      sensitiveDetailPolicy: "NEVER_PUBLIC",
    ),
    'searchStationTimetables|401|ROUTE_SESSION_REQUIRED': JourneyErrorDisposition(
      operation: 'searchStationTimetables',
      httpStatus: 401,
      code: JourneyErrorCode.routeSessionRequired,
      semanticCategory: JourneyErrorSemanticCategory.sessionAuthentication,
    ...
    'searchStationTimetables|429|ROUTE_RATE_LIMITED': JourneyErrorDisposition(
      operation: 'searchStationTimetables',
      httpStatus: 429,
      code: JourneyErrorCode.routeRateLimited,
      semanticCategory: JourneyErrorSemanticCategory.rateLimit,
    ...
    'profileJourneys|400|INVALID_TEMPORAL_QUERY': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 400,
      code: JourneyErrorCode.invalidTemporalQuery,
      semanticCategory: JourneyErrorSemanticCategory.requestCorrection,
      exposure: "MOBILE_USER_VISIBLE",
      userVisible: true,
      publicMessageKey: "journey.error.invalid_temporal_query",
      canonicalKoreanCopy: "시간 조건을 확인해 주세요.",
      mobileResourceKey: "journeyErrorInvalidTemporalQuery",
      mobilePresentation: "FAILURE_SCREEN",
      retryDisposition: "FORBIDDEN",
      primaryActionKey: JourneyErrorActionKey.journeyActionEditRequest,
      secondaryActionKey: null,
      safeDiagnosticKey: "journey.diagnostic.invalid_temporal_query",
      sensitiveDetailPolicy: "NEVER_PUBLIC",
    ),
    'profileJourneys|400|TEMPORAL_WINDOW_TOO_LARGE': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 400,
      code: JourneyErrorCode.temporalWindowTooLarge,
      semanticCategory: JourneyErrorSemanticCategory.requestCorrection,
      exposure: "MOBILE_USER_VISIBLE",
      userVisible: true,
      publicMessageKey: "journey.error.temporal_window_too_large",
      canonicalKoreanCopy: "검색 시간 범위를 줄여 주세요.",
      mobileResourceKey: "journeyErrorTemporalWindowTooLarge",
      mobilePresentation: "FAILURE_SCREEN",
      retryDisposition: "FORBIDDEN",
      primaryActionKey: JourneyErrorActionKey.journeyActionEditRequest,
      secondaryActionKey: null,
      safeDiagnosticKey: "journey.diagnostic.temporal_window_too_large",
      sensitiveDetailPolicy: "NEVER_PUBLIC",
    ),
    'profileJourneys|404|STATION_NOT_FOUND': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 404,
      code: JourneyErrorCode.stationNotFound,
      semanticCategory: JourneyErrorSemanticCategory.requestCorrection,
    ...
    'profileJourneys|422|NO_SERVICE_IN_DEPARTURE_WINDOW': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 422,
      code: JourneyErrorCode.noServiceInDepartureWindow,
      semanticCategory: JourneyErrorSemanticCategory.routeAbsent,
      exposure: "MOBILE_USER_VISIBLE",
      userVisible: true,
      publicMessageKey: "journey.error.no_service_in_departure_window",
      canonicalKoreanCopy: "선택한 시간대에 운행 정보가 없어요.",
      mobileResourceKey: "journeyErrorNoServiceInDepartureWindow",
      mobilePresentation: "FAILURE_SCREEN",
      retryDisposition: "FORBIDDEN",
      primaryActionKey: JourneyErrorActionKey.journeyActionEditRequest,
      secondaryActionKey: null,
      safeDiagnosticKey: "journey.diagnostic.no_service_in_departure_window",
      sensitiveDetailPolicy: "NEVER_PUBLIC",
    ),
    'profileJourneys|422|NO_ROUTE_ARRIVING_BY_DEADLINE': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 422,
      code: JourneyErrorCode.noRouteArrivingByDeadline,
      semanticCategory: JourneyErrorSemanticCategory.routeAbsent,
      exposure: "MOBILE_USER_VISIBLE",
      userVisible: true,
      publicMessageKey: "journey.error.no_route_arriving_by_deadline",
      canonicalKoreanCopy: "도착 시간까지 갈 수 있는 경로가 없어요.",
      mobileResourceKey: "journeyErrorNoRouteArrivingByDeadline",
      mobilePresentation: "FAILURE_SCREEN",
      retryDisposition: "FORBIDDEN",
      primaryActionKey: JourneyErrorActionKey.journeyActionEditRequest,
      secondaryActionKey: null,
      safeDiagnosticKey: "journey.diagnostic.no_route_arriving_by_deadline",
      sensitiveDetailPolicy: "NEVER_PUBLIC",
    ),
    'profileJourneys|422|NO_LAST_CONNECTION': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 422,
      code: JourneyErrorCode.noLastConnection,
      semanticCategory: JourneyErrorSemanticCategory.routeAbsent,
      exposure: "MOBILE_USER_VISIBLE",
      userVisible: true,
      publicMessageKey: "journey.error.no_last_connection",
      canonicalKoreanCopy: "현재 조건에서 이용할 수 있는 막차 연결이 없어요.",
      mobileResourceKey: "journeyErrorNoLastConnection",
      mobilePresentation: "FAILURE_SCREEN",
      retryDisposition: "FORBIDDEN",
      primaryActionKey: JourneyErrorActionKey.journeyActionEditRequest,
      secondaryActionKey: null,
      safeDiagnosticKey: "journey.diagnostic.no_last_connection",
      sensitiveDetailPolicy: "NEVER_PUBLIC",
    ),
    'profileJourneys|422|REALTIME_NOT_APPLICABLE_TO_TEMPORAL_QUERY': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 422,
      code: JourneyErrorCode.realtimeNotApplicableToTemporalQuery,
      semanticCategory: JourneyErrorSemanticCategory.requestCorrection,
      exposure: "MOBILE_USER_VISIBLE",
      userVisible: true,
      publicMessageKey: "journey.error.realtime_not_applicable_to_temporal_query",
      canonicalKoreanCopy: "선택한 시간에는 실시간 정보를 적용할 수 없어요.",
      mobileResourceKey: "journeyErrorRealtimeNotApplicableToTemporalQuery",
      mobilePresentation: "FAILURE_SCREEN",
      retryDisposition: "FORBIDDEN",
      primaryActionKey: JourneyErrorActionKey.journeyActionEditRequest,
      secondaryActionKey: null,
      safeDiagnosticKey: "journey.diagnostic.realtime_not_applicable_to_temporal_query",
      sensitiveDetailPolicy: "NEVER_PUBLIC",
    ),
    'profileJourneys|422|TEMPORAL_QUERY_TOO_COMPLEX': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 422,
      code: JourneyErrorCode.temporalQueryTooComplex,
      semanticCategory: JourneyErrorSemanticCategory.requestCorrection,
      exposure: "MOBILE_USER_VISIBLE",
      userVisible: true,
      publicMessageKey: "journey.error.temporal_query_too_complex",
      canonicalKoreanCopy: "검색 시간 범위를 줄여 주세요.",
      mobileResourceKey: "journeyErrorTemporalQueryTooComplex",
      mobilePresentation: "FAILURE_SCREEN",
      retryDisposition: "FORBIDDEN",
      primaryActionKey: JourneyErrorActionKey.journeyActionEditRequest,
      secondaryActionKey: null,
      safeDiagnosticKey: "journey.diagnostic.temporal_query_too_complex",
      sensitiveDetailPolicy: "NEVER_PUBLIC",
    ),
    'profileJourneys|503|REALTIME_REQUIRED_UNAVAILABLE': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 503,
      code: JourneyErrorCode.realtimeRequiredUnavailable,
      semanticCategory: JourneyErrorSemanticCategory.routingDataUnavailable,
    ...
    'profileJourneys|503|ROUTING_BUNDLE_UNAVAILABLE': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 503,
      code: JourneyErrorCode.routingBundleUnavailable,
      semanticCategory: JourneyErrorSemanticCategory.routingDataUnavailable,
    ...
    'profileJourneys|503|ROUTING_BUNDLE_STALE': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 503,
      code: JourneyErrorCode.routingBundleStale,
      semanticCategory: JourneyErrorSemanticCategory.routingDataStale,
    ...
    'profileJourneys|503|ROUTING_IDENTITY_MISMATCH': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 503,
      code: JourneyErrorCode.routingIdentityMismatch,
      semanticCategory: JourneyErrorSemanticCategory.routingIdentityFailure,
    ...
    'profileJourneys|503|RAPTOR_FRONTIER_CAPACITY_EXCEEDED': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 503,
      code: JourneyErrorCode.raptorFrontierCapacityExceeded,
      semanticCategory: JourneyErrorSemanticCategory.serviceUnavailable,
      exposure: "MOBILE_USER_VISIBLE",
      userVisible: true,
      publicMessageKey: "journey.error.raptor_frontier_capacity_exceeded",
      canonicalKoreanCopy: "경로 후보를 안전하게 계산하지 못했어요.",
      mobileResourceKey: "journeyErrorRaptorFrontierCapacityExceeded",
      mobilePresentation: "FAILURE_SCREEN",
      retryDisposition: "FORBIDDEN",
      primaryActionKey: JourneyErrorActionKey.journeyActionNewSearch,
      secondaryActionKey: null,
      safeDiagnosticKey: "journey.diagnostic.raptor_frontier_capacity_exceeded",
      sensitiveDetailPolicy: "NEVER_PUBLIC",
    ),
    'profileJourneys|504|JOURNEY_PROFILE_TIMEOUT': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 504,
      code: JourneyErrorCode.journeyProfileTimeout,
      semanticCategory: JourneyErrorSemanticCategory.searchTimeout,
      exposure: "MOBILE_USER_VISIBLE",
      userVisible: true,
      publicMessageKey: "journey.error.journey_profile_timeout",
      canonicalKoreanCopy: "시간대 경로 검색 시간이 초과되었어요. 다시 검색해 주세요.",
      mobileResourceKey: "journeyErrorJourneyProfileTimeout",
      mobilePresentation: "FAILURE_SCREEN",
      retryDisposition: "FORBIDDEN",
      primaryActionKey: JourneyErrorActionKey.journeyActionNewSearch,
      secondaryActionKey: null,
      safeDiagnosticKey: "journey.diagnostic.journey_profile_timeout",
      sensitiveDetailPolicy: "NEVER_PUBLIC",
    ),
    'profileJourneys|401|ROUTE_SESSION_REQUIRED': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 401,
      code: JourneyErrorCode.routeSessionRequired,
      semanticCategory: JourneyErrorSemanticCategory.sessionAuthentication,
    ...
    'profileJourneys|429|ROUTE_RATE_LIMITED': JourneyErrorDisposition(
      operation: 'profileJourneys',
      httpStatus: 429,
      code: JourneyErrorCode.routeRateLimited,
      semanticCategory: JourneyErrorSemanticCategory.rateLimit,
